...
async function getUserDocsSchema() {
  const userCollections = (await import("./collection-config_RwuXK7Hx.mjs")).collections
...
const $$StarlightPage = createComponent(
  ...
  "/app/node_modules/.bun/@astrojs+starlight@0.34.3+2337ed27ed217285/node_modules/@astrojs/starlight/components/StarlightPage.astro",
  void 0,
)
    ...
    return renderTemplate`${renderComponent(
      ...
      },
      {
        default: async ($$result2) =>
          renderTemplate` ${renderComponent($$result2, "Share", null, { id: id, api: apiUrl, info: data.info, messages: messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/app/packages/web/src/components/Share.tsx", "client:component-export": "default" })} `,
      },
    )} `
  },
  "/app/packages/web/src/pages/s/[id].astro",
  void 0,
)
const $$file = "/app/packages/web/src/pages/s/[id].astro"
const $$url = "/docs/s/[id]"
