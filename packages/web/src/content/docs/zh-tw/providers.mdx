...
1. 在 TUI 中執行 `/connect` 指令，選擇 `SlopCode Zen`，然後前往 [slopcode.ai/auth](https://slopcode.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `SlopCode Go`，然後前往 [slopcode.ai/auth](https://slopcode.ai/zen)。
