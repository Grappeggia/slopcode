...
Il file di configurazione ha uno schema definito in [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

La configurazione TUI usa [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
