...
- **macOS/Linux** (installazioni vecchie): `~/.local/share/slopcode/slopcode.jsonc`
...
1. Chiudi completamente SlopCode Desktop.
...
Se riscontri prestazioni lente, problemi di accesso ai file o problemi del terminale su Windows, prova a usare [WSL (Windows Subsystem for Linux)](/docs/windows-wsl). WSL fornisce un ambiente Linux che funziona in modo piu fluido con le funzionalita di SlopCode.
