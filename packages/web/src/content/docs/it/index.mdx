...
1. Esegui il comando `/connect` nella TUI, seleziona slopcode e vai su [slopcode.ai/auth](https://slopcode.ai/auth).
...
Ecco un'[esempio di conversazione](https://slopcode.ai/s/4XP1fce5) con SlopCode.
