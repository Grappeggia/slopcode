...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก slopcode และไปที่ [slopcode.ai/auth](https://slopcode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `SlopCode Go` และไปที่ [slopcode.ai/auth](https://slopcode.ai/zen)
