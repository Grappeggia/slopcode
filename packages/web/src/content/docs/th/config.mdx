...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json)

การกำหนดค่า TUI ใช้ [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json)
