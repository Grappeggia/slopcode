...
The server/runtime config schema is defined in [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

TUI config uses [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
