...
GPT-5.6 has exactly these effort variants, in catalog order:
...
The `minimal` effort belongs to older GPT-5 variants and is not part of GPT-5.6. Other OpenAI models may expose different effort sets.
