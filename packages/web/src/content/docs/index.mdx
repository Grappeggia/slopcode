...
SlopCode also ships through `winget`, `snap`, `nix profile`, `zypper`, `apk`, `pkg`, `MacPorts`, and release binaries.

See [Platforms](/docs/platforms) when you want the exact command for your system.
