...
1. Ejecute el comando `/connect` en TUI, seleccione slopcode y diríjase a [slopcode.ai/auth](https://slopcode.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `SlopCode Go` y diríjase a [slopcode.ai/auth](https://slopcode.ai/zen).
