...
Le fichier de configuration a un schéma défini dans [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

La configuration TUI utilise [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
