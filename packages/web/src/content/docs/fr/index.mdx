...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez slopcode et allez sur [slopcode.ai/auth](https://slopcode.ai/auth).
...
Voici un [exemple de conversation](https://slopcode.ai/s/4XP1fce5) avec SlopCode.
