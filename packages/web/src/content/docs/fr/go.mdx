...
| Kimi K2.7         | kimi-k2.7         | `https://slopcode.dev/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://slopcode.dev/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://slopcode.dev/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://slopcode.dev/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
| MiniMax M3        | minimax-m3        | `https://slopcode.dev/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
...
| Qwen3.7 Max       | qwen3.7-max       | `https://slopcode.dev/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://slopcode.dev/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://slopcode.dev/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
...
```
https://slopcode.dev/zen/go/v1/models
```
