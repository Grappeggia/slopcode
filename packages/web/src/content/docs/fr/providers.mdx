...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez slopcode et dirigez-vous vers [slopcode.ai/auth](https://slopcode.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `SlopCode Go` et rendez-vous sur [slopcode.ai/auth](https://slopcode.ai/zen).
