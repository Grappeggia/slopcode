---
title: TUI
description: Utilisation de l’interface utilisateur du terminal SlopCode.
---
...
Ceci est séparé de `slopcode.json`, qui configure le comportement du serveur/d'exécution.
...
- `leader_timeout` - Contrôle la durée pendant laquelle SlopCode attend après la leader key. Valeur par défaut : `2000`.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `slopcode.default`.
