...
Konfiguracijski fajl ima šemu koja je definirana u [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

TUI konfiguracija koristi [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
