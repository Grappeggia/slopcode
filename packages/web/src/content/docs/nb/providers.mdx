...
1. Kjør kommandoen `/connect` i TUI, velg `SlopCode Zen` og gå til [slopcode.ai/auth](https://slopcode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `SlopCode Go`, og gå til [slopcode.ai/auth](https://slopcode.ai/zen).
