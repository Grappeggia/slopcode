---
title: TUI
description: Bruke slopcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SlopCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre SlopCode starter TUI for gjeldende katalog.
...
Når du bruker SlopCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til SlopCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt SlopCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `slopcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge SlopCode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `slopcode.default`.
