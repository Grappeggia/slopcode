---
title: LSP-servere
description: slopcode integreres med LSP-serverne dine.
---

SlopCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `SLOPCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og slopcode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i SlopCode-konfigurasjonen.
