...
SlopCode Zen er en liste over testede og verifiserte modeller levert av SlopCode-teamet.

Zen fungerer som enhver annen leverandør i SlopCode. Du logger inn på SlopCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med SlopCode.
:::
...
SlopCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

SlopCode Zen fungerer som enhver annen leverandør i SlopCode.

1. Du logger inn på **<a href={console}>SlopCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger SlopCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i SlopCode-konfigurasjonen din
bruker formatet `slopcode/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `slopcode/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet SlopCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med SlopCode også.
