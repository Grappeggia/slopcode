...
İkili dosyayı [Releases](https://github.com/teamslop/slopcode/releases)'dan da alabilirsiniz.
...
Bu, SlopCode'un projenizi analiz etmesini ve bir `AGENTS.md` proje kökünde dosyası oluşturmasını sağlayacaktır.
...
1. **Bir plan oluşturun**
   ...
   SlopCode, değişiklik yapma özelliğini kapatan bir \_Plan modu\_\na sahiptir.
   ...
   **Tab** tuşunu kullanarak buna geçin. Bunun için sağ alt köşede bir gösterge göreceksiniz.
   ...
   :::tip
   SlopCode'a ne istediğinizi anlamasına yardımcı olacak bol miktarda bağlam ve örnek verin.
   :::
...
İşte SlopCode ile bir [örnek konuşma](https://slopcode.ai/s/4XP1fce5).
