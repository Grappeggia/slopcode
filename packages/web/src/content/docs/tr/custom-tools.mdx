---
title: Özel Araçlar
description: LLM'un slopcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. slopcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.slopcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/slopcode/tools/` içine yerleştirerek.
