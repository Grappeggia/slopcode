---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala slopcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

slopcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie slopcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI slopcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do slopcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij slopcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `slopcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo SlopCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `slopcode.default`.
