...
Możesz także pobrać plik binarny z [Releases](https://github.com/teamslop/slopcode/releases).
...
1. Uruchom polecenie `/connect` w TUI, wybierz slopcode i przejdź do [slopcode.ai/auth](https://slopcode.ai/auth).
...
Oto [przykładowa rozmowa](https://slopcode.ai/s/4XP1fce5) z slopcode.
