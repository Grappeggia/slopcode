...
1. Uruchom polecenie `/connect` w TUI, wybierz `SlopCode Zen` i przejdź do [slopcode.ai/auth](https://slopcode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `SlopCode Go` i przejdź do [slopcode.ai/auth](https://slopcode.ai/zen).
