...
1. Запустите команду `/connect` в TUI, выберите `SlopCode Zen` и перейдите по адресу [slopcode.ai/auth](https://slopcode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `SlopCode Go` и перейдите по адресу [slopcode.ai/auth](https://slopcode.ai/zen).
