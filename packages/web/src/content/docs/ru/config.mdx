...
Файл конфигурации имеет схему, определенную в [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

Конфигурация TUI использует [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
