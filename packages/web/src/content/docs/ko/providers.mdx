...
1. TUI에서 `/connect` 명령을 실행하고 `SlopCode Zen`을 선택한 뒤, [slopcode.ai/auth](https://slopcode.ai/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `SlopCode Go`를 선택한 뒤 [slopcode.ai/auth](https://slopcode.ai/zen)로 이동하십시오.
