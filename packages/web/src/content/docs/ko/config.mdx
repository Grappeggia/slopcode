...
server/runtime config schema는 [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json)에 정의되어 있습니다.

TUI config는 [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json)을 사용합니다.
