...
1. Run the `/connect` command in the TUI, select `SlopCode Zen`, and head to [slopcode.ai/auth](https://slopcode.ai/zen).
...
1. Run the `/connect` command in the TUI, select `SlopCode Go`, and head to [slopcode.ai/auth](https://slopcode.ai/zen).
