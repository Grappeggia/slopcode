...
1. شغّل الأمر `/connect` في TUI، واختر slopcode، ثم انتقل إلى [slopcode.ai/auth](https://slopcode.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `SlopCode Go`، ثم انتقل إلى [slopcode.ai/auth](https://slopcode.ai/zen).
