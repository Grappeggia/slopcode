...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في slopcode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في slopcode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.slopcode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/slopcode/tools/`.
