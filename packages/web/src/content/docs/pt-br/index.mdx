---
title: Introdução
description: Comece a usar o slopcode.
---
...
![slopcode TUI com o tema slopcode](../../../assets/lander/screenshot.png)
...
Para a melhor experiência no Windows, recomendamos usar o [Windows Subsystem for Linux (WSL)](/docs/windows-wsl). Ele oferece melhor desempenho e total compatibilidade com os recursos do slopcode.
:::
...
Você também pode baixar o binário na seção [Releases](https://github.com/teamslop/slopcode/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [SlopCode Zen](/docs/zen).
É uma lista selecionada de modelos que foram testados e verificados pela equipe do slopcode.

1. Execute o comando `/connect` no TUI, selecione slopcode e acesse [slopcode.dev/auth](https://slopcode.dev/auth).
...
1. **Criar um plano**
   ...
   O slopcode tem um _Modo de Plano_ que desabilita sua capacidade de fazer alterações e, em vez disso, sugere _como_ implementará o recurso.
   ...
   :::tip
   Dê ao slopcode bastante contexto e exemplos para ajudá-lo a entender o que você deseja.
   :::
...
As conversas que você tem com o slopcode podem ser [compartilhadas com sua equipe](/docs/share).
...
Aqui está uma [conversa de exemplo](https://slopcode.dev/s/4XP1fce5) com o slopcode.
...
Para torná-lo seu, recomendamos [escolher um tema](/docs/themes), [personalizar os atalhos de teclado](/docs/keybinds), [configurar formatadores de código](/docs/formatters), [criar comandos personalizados](/docs/commands) ou brincar com a [configuração do slopcode](/docs/config).
