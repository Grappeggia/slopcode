...
1. Execute o comando `/connect` no TUI, selecione slopcode e acesse [slopcode.ai/auth](https://slopcode.ai/auth).
...
Aqui está uma [conversa de exemplo](https://slopcode.ai/s/4XP1fce5) com o slopcode.
