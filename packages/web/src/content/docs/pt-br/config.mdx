...
O esquema de configuração do servidor/tempo de execução é definido em [**`slopcode.ai/config.json`**](https://slopcode.ai/config.json).

A configuração do TUI usa [**`slopcode.ai/tui.json`**](https://slopcode.ai/tui.json).
