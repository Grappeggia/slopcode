...
1. Execute o comando `/connect` no TUI, selecione `SlopCode Zen` e acesse [slopcode.ai/zen](https://slopcode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `SlopCode Go` e acesse [slopcode.ai/zen](https://slopcode.ai/zen).
