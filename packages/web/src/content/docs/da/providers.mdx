...
1. Kør kommandoen `/connect` i TUI, vælg slopcode og gå til [slopcode.ai/auth](https://slopcode.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `SlopCode Go`, og gå til [slopcode.ai/auth](https://slopcode.ai/zen).
