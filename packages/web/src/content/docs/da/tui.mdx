---
title: TUI
description: Brug af SlopCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

SlopCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre SlopCode starter TUI for den nuværende mappe.
...
Når du bruger SlopCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til SlopCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut SlopCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `slopcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe SlopCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `slopcode.default`.
