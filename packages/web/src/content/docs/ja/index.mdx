...
[Releases](https://github.com/teamslop/slopcode/releases).
...
1. TUI で `/connect` コマンドを実行し、slopcode を選択して、[slopcode.ai/auth](https://slopcode.ai/auth) で認証します。
...
これは [SlopCode を使用した会話 ](https://slopcode.ai/s/4XP1fce5) の例です。
