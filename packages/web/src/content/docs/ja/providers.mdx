...
1. TUI で `/connect` コマンドを実行し、`SlopCode Zen` を選択して、[slopcode.ai/zen](https://slopcode.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`SlopCode Go` を選択して、[slopcode.ai/zen](https://slopcode.ai/zen) にアクセスします。
