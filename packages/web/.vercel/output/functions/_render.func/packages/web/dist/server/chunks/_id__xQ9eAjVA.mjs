import { c as createAstro, a as createComponent, r as renderComponent, b as renderTemplate, q as renderSlot } from './astro/server_CGASYgNY.mjs';
import { Base64 } from 'js-base64';
import { H as HeadConfigSchema, b as urlToSlug, c as slugToLocaleData, d as getSidebarFromConfig, e as getSidebar, f as getSiteTitle, h as getToC, i as getSiteTitleHref, j as getPrevNextLinks, k as getHead, a as attachRouteDataAndRunMiddleware, $ as $$Page } from './middleware_BYQgbjtP.mjs';
import { a as stripLeadingAndTrailingSlashes, b as getCollectionPathFromRoot, p as project, s as starlightConfig } from './translations_Cdeps3jh.mjs';
import { I as Icons, d as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, e as parseWithFriendlyErrors } from './Code_CNdM9E30.mjs';
...
async function getUserDocsSchema() {
  const userCollections = (await import('./collection-config_DQMqhgqf.mjs')).collections;
...
}, "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/node_modules/.bun/@astrojs+starlight@0.34.3+d4a9ca0ffe30da47/node_modules/@astrojs/starlight/components/StarlightPage.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Share", null, { "id": id, "api": apiUrl, "info": data.info, "messages": messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/components/Share.tsx", "client:component-export": "default" })} ` })} `;
}, "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/pages/s/[id].astro", void 0);
const $$file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/pages/s/[id].astro";
const $$url = "/s/[id]";
