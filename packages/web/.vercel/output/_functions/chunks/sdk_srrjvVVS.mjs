...
const frontmatter = {
  title: "SDK",
  description: "Типобезопасный JS-клиент для сервера slopcode.",
}
...
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/ru/sdk.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
