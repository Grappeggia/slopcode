...
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/pl/ide.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
