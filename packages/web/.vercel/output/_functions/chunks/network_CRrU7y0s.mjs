...
function getHeadings() {
  return [
    ...
    {
      depth: 2,
      slug: "certificati-personalizzati",
      text: "Certificati personalizzati",
    },
  ]
}
...
const url = "src/content/docs/it/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/it/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
