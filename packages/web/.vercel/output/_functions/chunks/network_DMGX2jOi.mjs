...
function getHeadings() {
  return [
    ...
    {
      depth: 2,
      slug: "egendefinerte-sertifikater",
      text: "Egendefinerte sertifikater",
    },
  ]
}
...
const url = "src/content/docs/nb/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/nb/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
