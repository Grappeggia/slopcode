  ...
  return createVNode(Fragment, {
    children: [
      createVNode(Fragment$1, {
        "set:html":
          "<p>slopcode, tarayıcınızda bir web uygulaması olarak çalışabilir ve bir terminale ihtiyaç duymadan aynı güçlü AI kodlama deneyimini sağlayabilir.</p>\n",
      }),
