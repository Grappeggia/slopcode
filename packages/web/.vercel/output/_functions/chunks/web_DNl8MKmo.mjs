  ...
  return createVNode(Fragment, {
    children: [
      createVNode(Fragment$1, {
        "set:html":
          "<p>يمكن تشغيل SlopCode كتطبيق ويب داخل متصفحك، ليمنحك تجربة البرمجة القوية بالذكاء الاصطناعي نفسها دون الحاجة إلى terminal.</p>\n",
      }),
      ...
      createVNode(Fragment$1, {
        "set:html":
          '<h3 id="حالة-الخادم"><a href="#حالة-الخادم">حالة الخادم</a></h3>\n<p>انقر على “See Servers” لعرض الخوادم المتصلة وحالتها.</p>\n',
      }),
      createVNode(_components.p, {
        children: createVNode(_component0, {
