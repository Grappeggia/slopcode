...
const url = "src/content/docs/tr/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/tr/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
