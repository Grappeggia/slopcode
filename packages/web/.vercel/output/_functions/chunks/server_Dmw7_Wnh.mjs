        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">POST</code></td><td><code dir="auto">/provider/{id}/oauth/callback</code></td><td>Håndter OAuth-tilbakeringing for en leverandør</td><td><code dir="auto">boolean</code></td>',
              }),
            ],
          }),
        ],
        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">DELETE</code></td><td><code dir="auto">/session/:id</code></td><td>Slett en økt og alle dens data</td><td>Returnerer <code dir="auto">boolean</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">POST</code></td><td><code dir="auto">/session/:id/init</code></td><td>Analyser appen og lag <code dir="auto">AGENTS.md</code></td><td>body: <code dir="auto">{ messageID, providerID, modelID }</code>, returnerer <code dir="auto">boolean</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">POST</code></td><td><code dir="auto">/session/:id/abort</code></td><td>Avbryt en kjørende økt</td><td>Returnerer <code dir="auto">boolean</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">POST</code></td><td><code dir="auto">/session/:id/prompt_async</code></td><td>Send en melding asynkront (ingen vent)</td><td>body: samme som <code dir="auto">/session/:id/message</code>, returnerer <code dir="auto">204 No Content</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">POST</code></td><td><code dir="auto">/mcp</code></td><td>Legg til MCP-server dynamisk</td><td>body: <code dir="auto">{ name, config }</code>, returnerer MCP statusobjekt</td>',
              }),
            ],
          }),
        ],
...
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/nb/server.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
