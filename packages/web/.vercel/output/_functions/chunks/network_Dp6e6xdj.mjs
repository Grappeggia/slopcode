...
function getHeadings() {
  return [
    ...
    {
      depth: 2,
      slug: "brugerdefinerede-certifikater",
      text: "Brugerdefinerede certifikater",
    },
  ]
}
...
const url = "src/content/docs/da/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/da/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
