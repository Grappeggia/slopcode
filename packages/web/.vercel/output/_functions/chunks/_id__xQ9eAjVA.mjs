    ...
    return renderTemplate`${renderComponent(
      ...
      },
      {
        default: async ($$result2) =>
          renderTemplate` ${renderComponent($$result2, "Share", null, { id: id, api: apiUrl, info: data.info, messages: messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/components/Share.tsx", "client:component-export": "default" })} `,
      },
    )} `
  },
