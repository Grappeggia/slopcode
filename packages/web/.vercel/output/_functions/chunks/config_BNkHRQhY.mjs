...
try {
  ...
  console.error(
    '*** Failed to load Expressive Code config file "file:///home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/ec.config.mjs". You can ignore this message if you just renamed/removed the file.\n\n(Full error message: "' +
      (e?.message || e) +
      '")\n',
  )
}
