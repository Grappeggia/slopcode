...
function getHeadings() {
  return [
    ...
    {
      depth: 2,
      slug: "ใบรับรองที่กำหนดเอง",
      text: "ใบรับรองที่กำหนดเอง",
    },
  ]
}
...
const url = "src/content/docs/th/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/th/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
