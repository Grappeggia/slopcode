        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">session.delete({ path })</code></td><td>세션 삭제</td><td><code dir="auto">boolean</code> 반품</td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
              ...
              createVNode(Fragment$1, {
                "set:html":
                  '<tr><td><code dir="auto">session.init({ path, body })</code></td><td>앱 초기화 및 <code dir="auto">AGENTS.md</code> 분석</td><td><code dir="auto">boolean</code>를 반환</td></tr><tr><td><code dir="auto">session.abort({ path })</code></td><td>운영 중인 세션</td><td>반품 <code dir="auto">boolean</code></td></tr>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">session.summarize({ path, body })</code></td><td>세션 요약</td><td>반품 <code dir="auto">boolean</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">postSessionByIdPermissionsByPermissionId({ path, body })</code></td><td>허가 요청 대응</td><td>반품 <code dir="auto">boolean</code></td>',
              }),
            ],
          }),
        ],
        ...
        children: [
          ...
          createVNode(_components.tbody, {
            children: [
              ...
              createVNode(_components.tr, {
                "set:html":
                  '<td><code dir="auto">file.read({ query })</code></td><td>파일 보기</td><td><code dir="auto">{ type: "raw" | "patch", content: string }</code></td>',
              }),
              createVNode(_components.tr, {
                children: [
                  createVNode(_components.td, {
...
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/ko/sdk.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
