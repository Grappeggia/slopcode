...
function getHeadings() {
  return [
    ...
    {
      depth: 2,
      slug: "prilagođeni-certifikati",
      text: "Prilagođeni certifikati",
    },
  ]
}
...
const url = "src/content/docs/bs/network.mdx"
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/bs/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
