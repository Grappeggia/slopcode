...
const file = "/home/marcos/Disk-Combined-5.5TB/Projects/Personal/slopcode/packages/web/src/content/docs/ko/cli.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
