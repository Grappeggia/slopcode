...
class Database extends Context.Service<Database, DatabaseShape>()("@slopcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@slopcode/example/UserStore") {
