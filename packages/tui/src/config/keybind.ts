...
export const Definitions = {
  ...
  session_tabs_previous: keybind("<leader>[", "Activate the previous open session tab"),
  session_tabs_next: keybind("<leader>]", "Activate the next open session tab"),
  session_tabs_close: keybind("<leader>w", "Close the active session tab"),
  ...
  "dialog.memory.toggle": keybind("space", "Toggle memory in memory dialog"),
  "dialog.memory.add_project": keybind("ctrl+n", "Add project memory"),
...
export const CommandMap = {
  ...
  status_view: "slopcode.status",
  session_export: "session.export",
  session_copy: "session.copy",
  session_new: "session.new",
  session_list: "session.list",
  session_tabs_previous: "session.tabs.previous",
  session_tabs_next: "session.tabs.next",
  session_tabs_close: "session.tabs.close",
  session_timeline: "session.timeline",
  session_fork: "session.fork",
  session_rename: "session.rename",
  session_memories: "session.memories",
