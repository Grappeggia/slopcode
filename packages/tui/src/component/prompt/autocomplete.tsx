...
import { useBindings, useCommandSlashes, useSlopcodeModeStack } from "../../keymap"
import { displayCharAt, mentionTriggerIndex } from "../../prompt/display"
import type { FileSystemEntry } from "@slopcode-ai/sdk/v2"
...
export function Autocomplete(props: {
  ...
  function createFilePart(
    item: Pick<FileSystemEntry, "path" | "type">,
    filePath: string,
