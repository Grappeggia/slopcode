...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "SLOPCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/slopcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/slopcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/slopcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/slopcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const SLOPCODE_DB|SLOPCODE_DB|SLOPCODE_DEV|Global\\.Path\\.data|data =" in packages/slopcode/src (115 matches)',
  },
] as const
