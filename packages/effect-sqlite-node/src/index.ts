...
export const TypeId: TypeId = "~@slopcode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@slopcode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@slopcode-ai/effect-sqlite-node/NodeSqliteClient")
