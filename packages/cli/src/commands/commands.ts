...
declare const SLOPCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof SLOPCODE_CLI_NAME === "string" ? SLOPCODE_CLI_NAME : "slopcode", {
  description: "SlopCode 2.0 preview command line interface",
  commands: [
    Spec.make("debug", {
