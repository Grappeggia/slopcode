...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/slopcode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star SlopCode on GitHub",
}
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://slopcode.ai/">
            <strong>Try SlopCode</strong>
          </a>
          <button
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://slopcode.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://slopcode.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@slopcode.ai", label: "Contact us" },
    { href: "https://slopcode.ai/discord", label: "Community" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://slopcode.ai" aria-label="SlopCode home">
          <SlopCodeMark />
        </a>
      ...
      <div data-slot="modal-panel">
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">SlopCode Newsletter</h2>
            <p>
