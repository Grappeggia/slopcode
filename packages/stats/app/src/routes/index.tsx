...
const statsHomeTitle = "SlopCode Data"
const statsHomeDescription = "SlopCode usage data, market share, token cost, and session cost."
const statsHomeFallbackUrl = "https://slopcode.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.slopcode.ai") return "https://slopcode.ai/data/"
  if (url.hostname === "stats.dev.slopcode.ai") return "https://dev.slopcode.ai/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across SlopCode Go.</span>
      </h2>
      <Show
