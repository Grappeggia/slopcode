...
const en = {
  "app.title": "AI Model Usage Rankings | SlopCode Data",
  "app.description":
    "Explore SlopCode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "SlopCode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star SlopCode on GitHub",
  "header.github": "GitHub",
  "header.trySlopCode": "Try SlopCode",
  ...
  "home.topModelsDescription": "Usage of models across SlopCode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique SlopCode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | SlopCode Data",
  "lab.description":
    "Compare {{lab}} models used in SlopCode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent SlopCode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in SlopCode",
  ...
  "lab.shareOfUsage": "{{share}} of recent SlopCode usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily SlopCode token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | SlopCode Data",
  "model.description":
    "View {{model}} SlopCode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. SlopCode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's SlopCode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's SlopCode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No SlopCode Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent SlopCode Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no SlopCode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily SlopCode Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique SlopCode Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average SlopCode Go session shape.",
  ...
  "model.geoDescription": "SlopCode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No SlopCode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent SlopCode Go token volume.",
