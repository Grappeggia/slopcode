export const dict = {
  "app.title": "Rankingi użycia modeli AI | SlopCode Data",
  "app.description":
    "Przeglądaj użycie SlopCode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny SlopCode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę SlopCode na GitHub",
  "header.github": "GitHub",
  "header.trySlopCode": "Wypróbuj SlopCode",
  ...
  "footer.homeAria": "Strona główna SlopCode",
  ...
  "home.topModelsDescription": "Użycie modeli w SlopCode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy SlopCode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | SlopCode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w SlopCode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia SlopCode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w SlopCode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia SlopCode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów SlopCode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | SlopCode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w SlopCode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie SlopCode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu SlopCode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu SlopCode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia SlopCode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny SlopCode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia SlopCode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów SlopCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy SlopCode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji SlopCode Go.",
  ...
  "model.geoDescription": "Tokeny modelu SlopCode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne SlopCode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów SlopCode Go.",
