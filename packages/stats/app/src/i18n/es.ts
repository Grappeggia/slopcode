export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | SlopCode Data",
  "app.description":
    "Explora el uso de SlopCode Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de SlopCode Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a SlopCode en GitHub",
  "header.github": "GitHub",
  "header.trySlopCode": "Probar SlopCode",
  ...
  "footer.homeAria": "Inicio de SlopCode",
  ...
  "modal.title": "Boletín de SlopCode",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en SlopCode Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de SlopCode Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | SlopCode Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en SlopCode Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de SlopCode.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en SlopCode",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de SlopCode",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de SlopCode durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | SlopCode Data",
  "model.description":
    "Consulta datos de uso de {{model}} en SlopCode Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de SlopCode Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de SlopCode Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de SlopCode Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de SlopCode Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de SlopCode Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de SlopCode Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de SlopCode Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de SlopCode Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de SlopCode Go.",
  ...
  "model.geoDescription": "Tokens del modelo de SlopCode Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de SlopCode Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de SlopCode Go.",
