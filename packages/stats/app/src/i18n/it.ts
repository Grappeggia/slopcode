export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | SlopCode Data",
  "app.description":
    "Esplora l'utilizzo di SlopCode Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo SlopCode Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a SlopCode su GitHub",
  "header.github": "GitHub",
  "header.trySlopCode": "Prova SlopCode",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in SlopCode Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di SlopCode Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | SlopCode Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in SlopCode Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di SlopCode.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in SlopCode",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di SlopCode",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token SlopCode negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | SlopCode Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in SlopCode Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di SlopCode Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo SlopCode Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo SlopCode Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di SlopCode Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di SlopCode Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di SlopCode Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token SlopCode Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di SlopCode Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione SlopCode Go.",
  ...
  "model.geoDescription": "Token del modello SlopCode Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica SlopCode Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token SlopCode Go.",
