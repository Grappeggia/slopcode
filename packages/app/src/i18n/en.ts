export const dict = {
  ...
  "dialog.provider.slopcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.slopcode.tagline": "Reliable optimized models",
  "dialog.provider.slopcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by SlopCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in SlopCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.slopcodeZen.line1":
    "SlopCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.slopcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.slopcodeZen.visit.prefix": "Visit ",
  "provider.connect.slopcodeZen.visit.link": "slopcode.dev/zen",
  "provider.connect.slopcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in SlopCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in SlopCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in slopcode.json",
  ...
  "dialog.server.description": "Switch which SlopCode server this app connects to.",
  ...
  "wsl.onboarding.step.slopcode": "SlopCode",
  ...
  "wsl.onboarding.checkingSlopcode": "Checking SlopCode...",
  "wsl.onboarding.checkingSlopcodeIn": "Checking SlopCode in {{distro}}...",
  "wsl.onboarding.updatingSlopcode": "Updating SlopCode...",
  "wsl.onboarding.updatingSlopcodeIn": "Updating SlopCode in {{distro}}...",
  "wsl.onboarding.updateSlopcodeIn": "Update SlopCode in {{distro}}.",
  "wsl.onboarding.updateSlopcode": "Update SlopCode",
  "wsl.onboarding.slopcodeReadyIn": "SlopCode is ready in {{distro}}.",
  "wsl.onboarding.slopcodeReady": "SlopCode is ready.",
  "wsl.onboarding.installSlopcodeIn": "Install SlopCode in {{distro}}.",
  "wsl.onboarding.installSlopcode": "Install SlopCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen SlopCode.",
  ...
  "toast.update.description": "A new version of SlopCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the SlopCode team",
  ...
  "error.chain.checkConfig": "Check your config (slopcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, SlopCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "SlopCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "SlopCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the SlopCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for SlopCode",
  ...
  "settings.general.row.appearance.description": "Customise how SlopCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether SlopCode follows the system, light, or dark theme",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when SlopCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of SlopCode.",
