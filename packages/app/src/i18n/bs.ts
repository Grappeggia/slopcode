export const dict = {
  ...
  "dialog.provider.slopcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.slopcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.slopcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje SlopCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u SlopCode-u.",
  ...
  "provider.connect.slopcodeZen.line1":
    "SlopCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.slopcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.slopcodeZen.visit.link": "slopcode.ai/zen",
  "provider.connect.slopcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u SlopCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u SlopCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u slopcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se SlopCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija SlopCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku SlopCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (slopcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: SlopCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "SlopCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni SlopCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u SlopCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako SlopCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li SlopCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu SlopCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se SlopCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju SlopCode-a.",
