...
export const dict = {
  ...
  "dialog.provider.slopcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.slopcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.slopcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av SlopCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i SlopCode.",
  ...
  "provider.connect.slopcodeZen.line1":
    "SlopCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.slopcodeZen.visit.prefix": "Besøk ",
  "provider.connect.slopcodeZen.visit.link": "slopcode.ai/zen",
  "provider.connect.slopcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i SlopCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i SlopCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i slopcode.json",
  ...
  "dialog.server.description": "Bytt hvilken SlopCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av SlopCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til SlopCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (slopcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at SlopCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "SlopCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør SlopCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for SlopCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan SlopCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om SlopCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan SlopCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når SlopCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av SlopCode.",
