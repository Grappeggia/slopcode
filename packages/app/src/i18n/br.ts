export const dict = {
  ...
  "dialog.provider.slopcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.slopcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.slopcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo SlopCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no SlopCode.",
  ...
  "provider.connect.slopcodeZen.line1":
    "SlopCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no SlopCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no SlopCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em slopcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor SlopCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do SlopCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do SlopCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (slopcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: SlopCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "SlopCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor SlopCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do SlopCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o SlopCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o SlopCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o SlopCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o SlopCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do SlopCode.",
