export const dict = {
  ...
  "dialog.provider.slopcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.slopcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.slopcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez SlopCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w SlopCode.",
  ...
  "provider.connect.slopcodeZen.line1":
    "SlopCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.slopcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.slopcodeZen.visit.link": "slopcode.dev/zen",
  "provider.connect.slopcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w SlopCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w SlopCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w slopcode.json",
  ...
  "dialog.server.description": "Przełącz serwer SlopCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja SlopCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu SlopCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (slopcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "SlopCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla SlopCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd SlopCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy SlopCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw SlopCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania SlopCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji SlopCode.",
