...
beforeAll(async () => {
  ...
  mock.module("@slopcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@slopcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@slopcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@slopcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
