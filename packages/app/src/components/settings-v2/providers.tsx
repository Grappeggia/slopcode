...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "slopcode", key: "dialog.provider.slopcode.note" },
  { match: (id: string) => id === "slopcode-go", key: "dialog.provider.slopcodeGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "slopcode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "slopcode" || item.id === "slopcode-go"}>
