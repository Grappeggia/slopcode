import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@slopcode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@slopcode-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "slopcode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.slopcodeZen.line1")}</div>
