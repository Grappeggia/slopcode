import { AppIcon } from "@slopcode-ai/ui/app-icon"
...
export function SessionHeader() {
  ...
  onMount(() => {
    setCenterMount(document.getElementById("slopcode-titlebar-center"))
    setRightMount(document.getElementById("slopcode-titlebar-right"))
  })
