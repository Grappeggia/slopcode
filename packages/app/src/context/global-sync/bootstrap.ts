...
import { retry } from "@slopcode-ai/core/util/retry"
...
import { NormalizedProviderListResponse } from "@slopcode-ai/ui/context"
...
export const loadGlobalConfigQuery = (scope: ServerScope, sdk: SlopcodeClient) =>
  queryOptions({
    queryKey: [scope, "config"],
    queryFn: () => retry(() => sdk.global.config.get().then((x) => x.data!)),
  })

export const loadProjectsQuery = (scope: ServerScope, sdk: SlopcodeClient) =>
  queryOptions({
...
export const loadProvidersQuery = (scope: ServerScope, directory: string | null, sdk: SlopcodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "providers"],
    queryFn: () => retry(() => sdk.provider.list().then((x) => normalizeProviderList(x.data!))),
  })

export const loadAgentsQuery = (scope: ServerScope, directory: string | null, sdk: SlopcodeClient) =>
  queryOptions({
    queryKey: [scope, directory, "agents"],
    queryFn: () => retry(() => sdk.app.agents().then((x) => normalizeAgentList(x.data))),
  })

export const loadPathQuery = (scope: ServerScope, directory: string | null, sdk: SlopcodeClient) =>
  queryOptions<Path>({
