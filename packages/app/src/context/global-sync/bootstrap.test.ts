...
import type { Config, SlopcodeClient, Project } from "@slopcode-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@slopcode-ai/ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as SlopcodeClient
