...
const directory = "C:/SlopCode/ContextResizeRegression"
...
const model = { providerID: "slopcode", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["slopcode"],
    default: { providerID: "slopcode", modelID: "claude-opus-4-6" },
  }
}
