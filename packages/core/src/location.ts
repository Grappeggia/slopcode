...
export const RefJson = Schema.Struct({
  directory: AbsolutePath,
  workspaceID: Schema.optional(WorkspaceV2.ID),
}).pipe(
  Schema.decodeTo(Ref, {
    decode: SchemaGetter.transform((value) => Ref.make(value)),
...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Location") {}
