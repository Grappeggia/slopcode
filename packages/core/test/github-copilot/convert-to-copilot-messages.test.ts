import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@slopcode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
