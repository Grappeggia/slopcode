          ...
          Effect.scoped(
            Effect.gen(function* () {
              ...
              const mcp = source.pipe(
                ...
                Layer.provide(
                  Layer.succeed(MCPClient.Service, {
                    connect: () =>
                      Effect.fail(
                        new MCPClient.ConnectionError({
                          message: "MCP authentication is required",
                          code: "auth-required",
                        }),
                      ),
                  }),
              ...
              const context = yield* Layer.build(
                Layer.mergeAll(mcp, registry, permission, plugins, events, location, output),
              )
