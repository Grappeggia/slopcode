...
const releaseId = process.env.SLOPCODE_RELEASE
if (!releaseId) throw new Error("SLOPCODE_RELEASE is required")

const version = process.env.SLOPCODE_VERSION
if (!version) throw new Error("SLOPCODE_VERSION is required")
...
const macxTarGz = "slopcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "slopcode-desktop-mac-arm64.app.tar.gz"
