...
import type {
  ...
  RemoteAgentJobActionErrors,
  RemoteAgentJobActionResponses,
  RemoteAgentJobErrors,
  RemoteAgentJobEventsErrors,
  RemoteAgentJobEventsResponses,
  RemoteAgentJobResponses,
  ...
  V2SessionRuntimeErrors,
  V2SessionRuntimeResponses,
  V2SessionWaitErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new SlopcodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the SlopCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the SlopCode system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local SlopCode state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global SlopCode configuration settings and preferences.
   */
   ...
   *
   * Update global SlopCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the SlopCode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the SlopCode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all SlopCode instances, releasing all resources.
   */
   ...
   * Upgrade slopcode
   *
   * Upgrade slopcode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current SlopCode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update SlopCode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current SlopCode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the SlopCode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with SlopCode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that SlopCode is working with.
   */
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all SlopCode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new SlopCode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific SlopCode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Job extends HeyApiClient {
  /**
   * Stream remote agent job events
   *
   * Replay events after a cursor and continue streaming structured remote agent updates.
   */
  ...
  /**
   * Approve, answer, steer, review, stop, or retry a job
   *
  ...
  public action<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<
      ...
      ThrowOnError
    >({
      url: "/remote/agent/job/{jobID}/action",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Agent extends HeyApiClient {
  ...
  /**
   * Open an interactive remote agent session
   *
  ...
  public session<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<RemoteAgentSessionResponses, RemoteAgentSessionErrors, ThrowOnError>({
  ...
  /**
   * Start a resumable remote agent job
   *
  ...
  public job<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<RemoteAgentJobResponses, RemoteAgentJobErrors, ThrowOnError>({
      url: "/remote/agent/job",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Session3 extends HeyApiClient {
   ...
   * Get session runtime
   *
   * Retrieve native runtime ownership and state for a session.
   */
  public runtime<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "path", key: "sessionID" }] }])
    return (options?.client ?? this.client).get<V2SessionRuntimeResponses, V2SessionRuntimeErrors, ThrowOnError>({
...
export class SlopcodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<SlopcodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    SlopcodeClient.__registry.set(this, args?.key)
  }
