...
/**
 * Server configuration for slopcode serve and web commands
 */
...
export type RemoteAgentJobErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError1 | InvalidRequestError
...
export type RemoteAgentJobError = RemoteAgentJobErrors[keyof RemoteAgentJobErrors]

export type RemoteAgentJobResponses = {
  /**
   * Accepted remote agent job
   */
  200: {
    id: string
    workspaceID: string
...
export type RemoteAgentJobResponse = RemoteAgentJobResponses[keyof RemoteAgentJobResponses]

export type RemoteAgentJobEventsData = {
  body?: never
  path?: never
  query: {
    directory?: string
...
export type RemoteAgentJobEventsErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError1 | InvalidRequestError
...
export type RemoteAgentJobEventsError = RemoteAgentJobEventsErrors[keyof RemoteAgentJobEventsErrors]

export type RemoteAgentJobEventsResponses = {
  /**
   * Success
   */
  200: string
...
export type RemoteAgentJobEventsResponse = RemoteAgentJobEventsResponses[keyof RemoteAgentJobEventsResponses]
...
export type RemoteAgentJobActionErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError1 | InvalidRequestError
...
export type RemoteAgentJobActionError = RemoteAgentJobActionErrors[keyof RemoteAgentJobActionErrors]

export type RemoteAgentJobActionResponses = {
  /**
   * Updated remote agent job
   */
  200: {
    id: string
    workspaceID: string
