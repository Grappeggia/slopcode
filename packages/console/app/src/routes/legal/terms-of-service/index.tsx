...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>SlopCode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="SlopCode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <h2 id="what-is-slopcode">What is SlopCode?</h2>
              <p>
                SlopCode is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the SlopCode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, SlopCode enables you to
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by SlopCode;
                </li>
                <li>
              ...
              <p>
                If you use SlopCode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                SlopCode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                SlopCode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-slopcode-ever-change-the-services">Will SlopCode ever change the Services?</h2>
              <p>
              ...
              <p>
                SlopCode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. SlopCode has the sole right to decide whether you are
              ...
              <p>
                SlopCode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (SlopCode and all such
                parties together, the "SlopCode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the SlopCode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The SlopCode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY SLOPCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                SLOPCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO SLOPCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the SlopCode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without SlopCode's prior written
              ...
              <p>
                ...
                disputes and claims with SlopCode and limits the manner in which you can seek relief from SlopCode. Both
                you and SlopCode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, SlopCode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. SlopCode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. SlopCode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or SlopCode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND SLOPCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and SlopCode are instead choosing to have claims and disputes resolved by
                ...
                you and SlopCode over whether to vacate or enforce an arbitration award, YOU AND SLOPCODE WAIVE ALL
              ...
              <p>
                ...
                SlopCode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or SlopCode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and SlopCode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the SlopCode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and SlopCode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and SlopCode, and
                ...
                are not an employee, agent, partner, or joint venture of SlopCode, and you do not have any authority of
                any kind to bind SlopCode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and SlopCode
