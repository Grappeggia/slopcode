...
import type { Config as PluginConfig, PluginOptions } from "./index"

export type { CliRenderer } from "@opentui/core"

export type SlotMode = "append" | "prepend" | "replace" | "single_winner"
...
export type TuiSlotPlugin<Slots extends Record<string, object> = {}> = {
  order?: number
  slots: {
    [Name in keyof TuiSlotMap<Slots>]?: SlotHandler<TuiSlotMap<Slots>[Name]>
  }
}
