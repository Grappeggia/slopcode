...
describe("tool.skill", () => {
  it.instance("execute returns skill content block with files", () =>
    Effect.gen(function* () {
      ...
      const skill = path.join(dir, ".slopcode", "skill", "tool-skill")
...
`,
      ...
      const home = process.env.SLOPCODE_TEST_HOME
      process.env.SLOPCODE_TEST_HOME = dir
