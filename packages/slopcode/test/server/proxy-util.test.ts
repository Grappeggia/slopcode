...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips slopcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-slopcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-slopcode-directory")).toBeNull()
      expect(result.get("x-slopcode-workspace")).toBeNull()
