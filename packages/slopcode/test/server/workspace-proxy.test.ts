...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips slopcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-slopcode-directory"]).toBeUndefined()
      expect(forwarded["x-slopcode-workspace"]).toBeUndefined()
