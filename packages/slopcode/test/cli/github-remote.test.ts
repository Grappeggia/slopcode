...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/slopcode.git")).toEqual({ owner: "sst", repo: "slopcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/slopcode")).toEqual({ owner: "sst", repo: "slopcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/slopcode.git")).toEqual({ owner: "sst", repo: "slopcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/slopcode")).toEqual({ owner: "sst", repo: "slopcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/slopcode.git")).toEqual({ owner: "sst", repo: "slopcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/slopcode")).toEqual({ owner: "sst", repo: "slopcode" })
})
