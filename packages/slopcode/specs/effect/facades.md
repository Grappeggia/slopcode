...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/slopcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy slopcode service removed
