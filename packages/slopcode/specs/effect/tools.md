...
Practical reference for the current tool-migration state in `packages/slopcode`.
...
Tool tests should use the existing Effect helpers in `packages/slopcode/test/lib/effect.ts`:
