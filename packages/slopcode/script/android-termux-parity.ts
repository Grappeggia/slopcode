...
export const parity = [
  ...
  },
  {
    ...
    linux: [
      ...
      "cursor append after recall",
      "default prompt keymap",
    ],
    android: [
      "bracketed multiline paste",
      "prompt history recall",
  ...
  },
  {
    ...
    status: "active",
    linux: [
      "question dialog renders",
      "keyboard selection",
      "custom and multiple answers",
      "reply and reject through daemon API",
    ],
    android: [
      "question dialog renders",
      "keyboard selection",
