...
export const parity = [
  ...
  },
  {
    ...
    android: ["open real file", "editor input focus", "edit/save", "dirty guard", "diagnostics", "diff open/dismiss", "snapshot preview"],
    expect: ["open real file", "editor input focus", "edit/save", "dirty guard", "diagnostics", "diff open/dismiss", "snapshot preview"],
  },
  {
    id: "terminal.polish",
    phase: 5,
