...
export const parity = [
  ...
  },
  {
    ...
    active: true,
    status: "active",
    linux: ["bracketed multiline paste", "prompt history recall", "cursor append after recall", "default prompt keymap"],
    android: ["bracketed multiline paste", "prompt history recall", "cursor append after recall", "default prompt keymap"],
    expect: ["bracketed multiline paste", "prompt history recall", "cursor append after recall", "default prompt keymap"],
  },
  {
  ...
  },
  {
    ...
    active: true,
    status: "active",
    linux: ["question dialog renders", "keyboard selection", "custom and multiple answers", "reply and reject through daemon API"],
    android: ["question dialog renders", "keyboard selection", "custom and multiple answers", "reply and reject through daemon API"],
    expect: ["question dialog renders", "keyboard selection", "custom and multiple answers", "reply and reject through daemon API"],
  },
  {
    id: "layout.capture",
    phase: 1,
  ...
  },
  {
    ...
    android: ["interactive command palette", "searchable aliases", "keybound selection"],
    expect: ["interactive command palette", "searchable aliases", "keybound selection"],
  },
  {
    id: "commands.linux-parity",
    phase: 2,
    area: "commands",
    mode: "parity",
    level: "true-parity",
    ...
    android: [
      "daemon-backed autocomplete model panel",
      "provider model variant panel",
      "daemon shell selector panel",
      "provider account/org panel",
      "config-backed plugin list",
      "daemon skill command panel",
      "session display toggles",
    ],
    expect: [
      "daemon-backed autocomplete model panel",
  ...
  },
  {
    ...
    active: true,
    status: "active",
    linux: ["permission request panel", "focused and selected requests", "pattern preview", "once/always/reject replies"],
    android: ["permission request panel", "focused and selected requests", "pattern preview", "once/always/reject replies"],
    expect: ["permission request panel", "focused and selected requests", "pattern preview", "once/always/reject replies"],
  },
  {
    id: "tabs.rich",
    phase: 3,
    ...
    android: ["chat tab", "multiple editor tab rows", "inactive/active tab markers", "dirty marker", "last tab close"],
    expect: ["chat tab", "multiple editor tab rows", "inactive/active tab markers", "dirty marker", "last tab close"],
  },
  {
    id: "sidebar.files",
    phase: 3,
  ...
  },
  {
    ...
    active: true,
    status: "active",
    linux: ["shared TUI manifest route", "normalized snapshot route", "typed action route"],
    android: [
      "fetches shared TUI manifest",
      "hydrates shared TUI snapshot",
      "manifest-backed command completion",
      "manifest-backed keybind panel",
      "snapshot-backed transcript footer and tabs",
    ],
    expect: [
      "shared TUI manifest route",
      "normalized snapshot route",
      "typed action route",
      "manifest-backed Android commands",
      "snapshot-backed Android transcript footer and tabs",
    ],
  },
  {
