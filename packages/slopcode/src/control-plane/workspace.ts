...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SLOPCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SLOPCODE_WORKSPACE_ID: config.id,
        SLOPCODE_EXPERIMENTAL_WORKSPACES: "true",
