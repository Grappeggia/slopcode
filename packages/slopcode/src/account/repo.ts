...
import { AccountStateTable, AccountTable } from "@slopcode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@slopcode/AccountRepo") {}
