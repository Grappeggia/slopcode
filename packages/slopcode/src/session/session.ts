...
import { Slug } from "@slopcode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@slopcode-ai/llm"
...
import { PartTable, SessionTable } from "@slopcode-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@slopcode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".slopcode", "plans")
...
export interface Interface {
  ...
  readonly updateMessage: <T extends SessionV1.Info>(msg: T, guard?: Effect.Effect<void>) => Effect.Effect<T>
...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Session") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const updateMessage = <T extends SessionV1.Info>(msg: T, guard?: Effect.Effect<void>): Effect.Effect<T> =>
      Effect.gen(function* () {
