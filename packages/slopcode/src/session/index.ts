import { Slug } from "@slopcode-ai/util/slug"
...
export namespace Session {
  ...
  export async function createNext(input: {
    ...
    if (!result.parentID && (Flag.SLOPCODE_AUTO_SHARE || cfg.share === "auto"))
  ...
  export const getUsage = fn(
    ...
    (input) => {
      ...
      // It looks like SlopCode's cost calculation assumes all providers return inputTokens the same way Anthropic does (I'm guessing getUsage logic was originally implemented with anthropic), so it's causing incorrect cost calculation for OpenRouter and others.
