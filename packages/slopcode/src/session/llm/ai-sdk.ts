import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@slopcode-ai/llm"
...
// Move this extraction into @slopcode-ai/llm when Copilot is handled by the native runtime.
