...
import { httpClient, path } from "@slopcode-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@slopcode/SkillDiscovery") {}
