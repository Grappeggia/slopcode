...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Plugin") {}
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  const legacy = (plugin: unknown) => plugin as PluginInstance
  return [
    ...
    CopilotAuthPlugin,
    legacy(GitlabAuthPlugin),
    legacy(PoeAuthPlugin),
