...
import type { Event, GlobalEvent, SlopcodeClient } from "@slopcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@slopcode/RunStreamTransport") {}
