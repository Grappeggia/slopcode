...
//
// The saved variant persists across sessions in ~/.local/state/slopcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@slopcode/RunVariant") {}
