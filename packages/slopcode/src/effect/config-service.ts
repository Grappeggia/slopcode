 ...
 *   "@slopcode/ServerAuthConfig",
 *   {
 *     password: Config.string("SLOPCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SLOPCODE_SERVER_USERNAME").pipe(Config.withDefault("slopcode")),
 *   },
 * ) {}
 *
