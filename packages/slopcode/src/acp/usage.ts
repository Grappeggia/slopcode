...
import type { AssistantMessage as SlopCodeAssistantMessage, Message } from "@slopcode-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<SlopCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SlopCodeAssistantMessage, "role"> &
  Partial<Pick<SlopCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@slopcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@slopcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@slopcode/ACPUsage") {}
