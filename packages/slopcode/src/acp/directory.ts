...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@slopcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@slopcode/ACPDirectory") {}
