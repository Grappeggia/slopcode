...
import { which } from "@slopcode-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@slopcode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.SLOPCODE_FAKE_VCS)
