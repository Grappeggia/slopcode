...
export const RootHttpApi = HttpApi.make("slopcode-root")
...
export const InstanceHttpApi = HttpApi.make("slopcode-instance")
  ...
  .addHttpApi(RemoteRuntimeApi)
  .middleware(SchemaErrorMiddleware)

export const SlopCodeHttpApi = HttpApi.make("slopcode")
