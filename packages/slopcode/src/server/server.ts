      ...
      app
        ...
        .use(
          cors({
            origin(input) {
              ...
              // *.slopcode.ai (https only, adjust if needed)
              if (/^https:\/\/([a-z0-9-]+\.)*slopcode\.ai$/.test(input)) {
                return input
              }
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current SlopCode instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the SlopCode instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the SlopCode system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the SlopCode system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the SlopCode system.",
        ...
        .all("/*", async (c) => {
          ...
          const response = await proxy(`https://app.slopcode.ai${path}`, {
            ...c.req,
            headers: {
              ...c.req.raw.headers,
              host: "app.slopcode.ai",
            },
          })
