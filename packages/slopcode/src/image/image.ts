...
export class Service extends Context.Service<Service, Interface>()("@slopcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SLOPCODE_PHOTON_WASM_PATH?: string }).__SLOPCODE_PHOTON_WASM_PATH =
