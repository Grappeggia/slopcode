...
Schema-first LLM core for slopcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@slopcode-ai/llm"
import { OpenAI } from "@slopcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@slopcode-ai/llm/providers"
