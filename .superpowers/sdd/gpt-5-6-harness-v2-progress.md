...
Task H5E1: final review complete with Windows capability concern (commits `536663e781`, `a600bb976e`, `90676164fc`; Core 1581/1581, focused 100/100, Slopcode 3111/3111 with 22 skip and 1 todo, V1 formatter/config 105/105, CodeMode 254/254, all typechecks and frozen install clean; Linux/Darwin POSIX adapters, external Location staging, recoverable delete conflicts, retained watcher callbacks, and durable runner restart/no-replay implemented; Windows fails closed pending a reviewed NT handle-relative helper).
