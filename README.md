...
SlopCode is also available as a desktop application. Download directly from the [releases page](http://github.com/teamslop/slopcode/releases) or [slopcode.dev/download](https://slopcode.dev/download).
